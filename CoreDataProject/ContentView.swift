...
struct ContentView: View {
    ...
    @State private var predicateType: PredicateTypes = .beginsWith
...
//            }
            ...
            FilteredList(filterKey: "lastName", filterValue: lastNameFilter, sortDescriptor: SortDescriptor(\.firstName), predicateType: predicateType) { (singer: Singer) in
